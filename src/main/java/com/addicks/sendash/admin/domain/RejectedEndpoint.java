...
@Entity
public class RejectedEndpoint implements Serializable {
  ...
  public RejectedEndpoint() {

  }

  public RejectedEndpoint(PendingEndpoint pendingEndpoint) {
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    RejectedEndpoint other = (RejectedEndpoint) obj;
    if (apiKey == null) {
