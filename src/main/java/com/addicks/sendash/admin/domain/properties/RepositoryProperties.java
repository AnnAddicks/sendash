package com.addicks.sendash.admin.domain.properties;
...
public class RepositoryProperties {
  ...
  public String getZipOfRep() {
    return zipOfRep;
  }

  public void setZipOfRep(String zipOfRep) {
    this.zipOfRep = zipOfRep;
  }
